...
pub const RENDER_WIDTH:   usize = 64;
pub const RENDER_HEIGHT:  usize = 32;
...
pub const PROG_ROM_RAM_BEGIN: u16 = 0x200;
...
pub struct Chip8 {
    ...
    sp:     u8,  // stack pointer
    pub render_out: Vec<u8>,  // should have RENDER_WIDTH * RENDER_HEIGHT elements, 64x32 B&W display

    pub draw_flag: bool,  // whether or not a GUI application should render
}
...
impl Chip8 {
    ...
    pub fn new () -> Chip8 {
        ...
        for _ in 0..MEMORY_BYTES { c8.memory.push(0); }
        for _ in 0..(RENDER_WIDTH * RENDER_HEIGHT) { c8.render_out.push(0); }
        c8.init(42);
        c8
    }
    ...
    pub fn load_rom_file (&mut self, path: &str) -> std::io::Result<()> {
        self.init(42);
    ...
    pub fn get_memory_range (&mut self, begin: usize, count: usize) -> &[u8] {
        &self.memory[begin..begin+count]
    }
